...
results to a specified log (intended for Rails log).It uses the RubyProf::FlatPrinter which is
...
ProfileAction.configure do |c|
  ...
  # By default log level is :info.
   ...
   c.profile = ENV.fetch("PROFILE") == '1'
 end

 # Include in controller and create an around filter/action.
